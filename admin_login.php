...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con,"SELECT * FROM `admin_details` WHERE `admin_id`='$username'");
...
<body>
    ...
    <h2 class="heading">Admin Login/Signup</h2>
    <form method="POST">
        <div class="form-group form">
            <h4>Username</h4>
            <input type="text" class="form-control" name="username" placeholder="Enter Your Admin ID" required>
            <br><br>
            <h4>Password</h4>
